...
- 🔐 **Authentification JWT** avec tokens sécurisés  
  → Messages d’erreur et de succès clairs et concis.
- 🔄 **Système de Refresh Token** pour une sécurité renforcée
- 🛡️ **Spring Security 6** avec configuration avancée (filtres, contrôles d’accès)
